            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="crud_ciudadanos.php" method="post">
                        <label for="txt_codigo" class="form-label">Codigo de Ciudadano: </label>
                        ...
                        <br>
                        <button type="submit" class="form-control btn btn-primary">Agregar un nuevo ciudadano</button>
                    </form>
                </div>
            ...
            <?php while ($fila = mysqli_fetch_array($ejecutar)) { ?>
                <tr>
                    ...
                    <td class="d-flex flex-row">
                        <form action="crud_ciudadanos.php" method="post" class="me-2">
                            <input type="hidden" name="hidden_codigo" value="<?php echo $fila['dpi']; ?>">
                            <button type="submit" name="btn_eliminar" class="btn btn-outline-danger">
                                <i class="bi bi-trash3"></i>
                            </button>
                        </form>
                        <form action="actualizar_ciudadanos.php" method="post">
                            <input type="hidden" name="hidden_codigoa" value="<?php echo $fila['dpi']; ?>">
